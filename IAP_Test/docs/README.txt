...
using externally generated SPI activitiy by a master lpc8xx. 
...
* The master and slave boards must be connected as per the pins defined in the main c files
  ...
  // SPI0 (master board)       ... connect to ... SPI1 (slave board)
  // SPI0_SCK on master board  ... connect to ... SPI1_SCK on slave board
  // SPI0_MOSI on master board ... connect to ... SPI1_MOSI on slave board
  // SPI0_SSEL on master board ... connect to ... SPI1_SSEL on slave board
...
* main() routine
  ...
  3. SPI0 and its clocking are configured for 1 mbps, master mode, RXIGNORE = true, 8 data bits,
  ...
  5. Either '0', '1', or '2' is transmitted by SPI0 (recieved data in SPI0 RXDAT is ignored).
